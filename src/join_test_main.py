...
from src.utils.count import count_object_object, noise_count_object_object, count_object_subject, noise_count_object_subject,count_bound_object_subject, noise_count_bound_object_subject
...
RDF_O_O_WHOLE_PREDICATE_1 = "<https://test.com/whatever#predicate>"
RDF_O_O_WHOLE_PREDICATE_2 = "<https://test.com/whatever#predicate2>"
...
RDF_O_S_WHOLE_PREDICATE_1 = "<https://test.com/whatever#predicate>"
RDF_O_S_PRED_PREFIX_2 = "<https://test.com/whatever#>"
RDF_O_S_PREDICATE_2 = "predicate2"
RDF_O_S_WHOLE_PREDICATE_2 = "<https://test.com/whatever#predicate2>"
...
RDF_B_O_S_WHOLE_PREDICATE_1 = "<https://test.com/whatever#predicate>"
RDF_B_O_S_PRED_PREFIX_2 = "<https://test.com/whatever#>"
RDF_B_O_S_PREDICATE_2 = "predicate2"
RDF_B_O_S_WHOLE_PREDICATE_2 = "<https://test.com/whatever#predicate2>"
RDF_B_O_S_OBJECT = "ENDOBJECT"

RDF_B_O_S_PREFIXES = [RDF_B_O_S_PRED_PREFIX_1,RDF_B_O_S_PRED_PREFIX_2]
...
def o_o_join(graph):
    ...
    o_o_cms_result = count_object_object(o_o_cms_p1, o_o_cms_p2, RDF_O_O_WHOLE_PREDICATE_1,
                                         RDF_O_O_WHOLE_PREDICATE_2, graph)
...
def noise_o_o_join(graph):
    ...
    o_o_cms_result = noise_count_object_object(o_o_cms_p1, o_o_cms_p2, RDF_O_O_WHOLE_PREDICATE_1,
                                         RDF_O_O_WHOLE_PREDICATE_2, graph, np.amin)
...
def o_s_join(graph):
    ...
    o_s_cms_result = count_object_subject(o_s_cms_p1, o_s_cms_p2, RDF_O_S_WHOLE_PREDICATE_1,
                                         RDF_O_S_WHOLE_PREDICATE_2, graph)
...
def noise_o_s_join(graph):
    ...
    o_s_cms_result = noise_count_object_subject(o_s_cms_p1, o_s_cms_p2, RDF_O_S_WHOLE_PREDICATE_1,
                                         RDF_O_S_WHOLE_PREDICATE_2, graph,np.amin)
...
def b_o_s_join(graph):
    ...
    b_o_s_cms_result = count_bound_object_subject(b_o_s_cms_p1, b_o_s_cms_p2, RDF_B_O_S_WHOLE_PREDICATE_1,
                                         RDF_B_O_S_WHOLE_PREDICATE_2,RDF_B_O_S_OBJECT, graph)

    b_o_s_query_result = bound_object_subject_join(data_graph=graph, endings=RDF_B_O_S_ENDINGS, prefixes=RDF_B_O_S_PREFIXES)
...
def noise_b_o_s_join(graph):
    ...
    b_o_s_cms_result = noise_count_bound_object_subject(b_o_s_cms_p1, b_o_s_cms_p2, RDF_B_O_S_WHOLE_PREDICATE_1,
                                         RDF_B_O_S_WHOLE_PREDICATE_2,RDF_B_O_S_OBJECT, graph,np.amin)
