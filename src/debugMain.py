...
if __name__ == '__main__':
    ...
    datalist = [["../data/yago-1.0.0-turtle_abridged.ttl","ttl"]]#[["https://yago-knowledge.org/data/yago1/yago-1.0.0-turtle.7z","ttl"]]#[["https://raw.githubusercontent.com/maribelacosta/linkeddata/master/data/alan_turing.ttl","ttl"]]
